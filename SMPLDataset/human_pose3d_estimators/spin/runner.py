...
from human_pose3d_estimators.geometry.boxes import cal_head_bbox
from human_pose3d_estimators.geometry.cam_pose_utils import cam_init2orig, cam_norm
...
class SPINRunner(BasePose3dRunner):
    ...
    def run_with_smplify(self, image_paths: List[str], boxes: List[Union[List, Tuple, np.ndarray]],
                         keypoints_info, smplify_runner: BasePose3dRefiner,
